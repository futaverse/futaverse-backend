...
from .views import VerifySignupOTPView, LoginView, CustomTokenRefreshView, ForgotPasswordView, VerifyForgotPasswordOTPView, ResetPasswordView, CreateStudentView, CreateAlumnusView, MeView
