...
from .serializers import (
    PostSerializer,
    ShareEngagementCompletionSerializer,
    ShareEngagementSerializer,
)
...
@extend_schema(
    tags=["Posts"],
    summary="Share an internship or mentorship engagement as a post (student)",
)
class ShareEngagementView(generics.GenericAPIView):
    ...
    def post(self, request):
        ...
        post = share_engagement(
            user=request.user, engagement=engagement, custom_text=content
        )
...
@extend_schema(
    tags=["Posts"], summary="List all public posts shared by the logged in user"
)
...
@extend_schema(
    tags=["Posts"], summary="List all public posts shared by a specific user"
)
...
@extend_schema(
    tags=["Posts"],
    summary="Share the completion of an internship or mentorship engagement as a post (student)",
)
